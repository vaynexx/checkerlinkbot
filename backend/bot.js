...
try {
  ...
  console.error('❌ Failed to initialize Telegraf bot:', err.message);
  bot = null;
}
...
// Setup bot handlers if bot is available
if (bot) {
...
if (bot) {
  ...
  console.warn('⚠️ Bot не буде запущено - BOT_TOKEN не встановлено');
}